...
<section class="relative h-[600px] w-full overflow-hidden">
  <img 
    src="/generated/image-confident-real-estate-developer-or-prope-1765581192988-5.webp" 
    alt="Partnership" 
    class="w-full h-full object-cover"
  />
  
  <div class="absolute inset-0 bg-black/40 flex items-center justify-center px-6">
    <div class="grid grid-cols-1 md:grid-cols-2 max-w-[1000px] w-full items-center gap-8">
      <div class="text-white text-[40px] font-light leading-tight mb-8 md:mb-0 pr-8">
        Transform distressed<br>properties into<br>luxury opportunities.
      </div>
      
      <div class="bg-white rounded-xl p-12 flex flex-col items-center justify-center text-center">
        <!-- OnPoint Logo -->
        <div class="mb-6 w-24 h-24 text-primary-600">
        ...
        <p class="text-gray-900 text-xl font-light">Excellence in every detail</p>
      </div>
    </div>
  </div>
</section>
